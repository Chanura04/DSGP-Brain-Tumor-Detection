...
# Data Preprocessing = Used a multi-channel input (3 channels: raw, Fast Non Local Means Denoising (FNLMD), and Contrast Limited Adaptive Histogram Equalization (CLAHE))
...
Although the experiment 26 gave a stable model with high accuracy, model limitations were reached and a more complex approach was taken such as multi-channel input (3-channels) for the same model, to try and increase model accuracy and stability.
