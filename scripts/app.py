        ...
        if st.session_state.results_ready:
            if st.session_state.ct_tumor_result == "No Tumor Detected":
                ...
                with result_col1:
                    ...
                    st.markdown(
                        f'<div class="status-alert" style="background: rgba(255,75,75,0.2); border: 1px solid #ff4b4b; color: #ff4b4b;">🔴 {ct_tumor_result}</div>',
                        unsafe_allow_html=True)
                ...
                with result_col2:
                    ...
                    # Centered Error Alert
                    st.markdown(
                        f'<div class="status-alert" style="background: rgba(255,75,75,0.2); border: 1px solid #ff4b4b; color: #ff4b4b;">🔴 {mri_tumor_class}</div>',
                        unsafe_allow_html=True)
                ...
                if st.session_state.get('report_submitted', False):
                    ...
                    st.download_button(
                        ...
                        data=save_text_report(feedback_id, ct_tumor_result, mri_tumor_class, rad_name, rad_phone,
                                              rad_email, rad_comment),
